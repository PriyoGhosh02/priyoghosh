...
const appCss = "/assets/styles-xA1eUkWl.css";
const profileFavicon = "/assets/fav_2-BcfqUlL-.png";
...
const Route$2 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "A modern, monochrome developer portfolio with a persistent 3D animated background and interactive project previews." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "A modern, monochrome developer portfolio with a persistent 3D animated background and interactive project previews." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "A modern, monochrome developer portfolio with a persistent 3D animated background and interactive project previews." }
    ],
    links: [
      {
        rel: "preconnect",
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Barlow:wght@400;500;600;700;800&family=Inter:wght@300;400;500;600&family=JetBrains+Mono:wght@400;500&display=swap"
      },
      {
        rel: "stylesheet",
        href: appCss
...
const $$splitComponentImporter = () => import("./index-BCmCQyBm.js");
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio of Priyo Ghosh — aspiring full-stack web developer building responsive interfaces with React, Next.js, Tailwind, Node.js and MongoDB."
    }, {
      property: "og:title",
      content: "Priyo Ghosh — Full Stack Web Developer"
    }, {
      property: "og:description",
      content: "Monochrome portfolio of Priyo Ghosh — full-stack web developer based in Dhaka, Bangladesh."
    }]
  }),
